...
import img from '../components/Assets/gulhane brocher 1-4 2.jpg'
// import Footer from '../Components/Footer';
import diguimg from '../components/Assets/diguimg.jpeg'
...
const ContactUs = () => {
  ...
  const address = encodeURIComponent("GULHANE PROPERTIES");
  return (
    <>
      ...
      <section className="text-gray-400  body-font relative mt-0">
         ...
         <div className="container px-5 py-10 mx-auto flex sm:flex-nowrap flex-wrap">
          ...
          <img src={diguimg} alt="" className='w-[590px] h-[500px] m-auto rounded-lg' />
          {/* <div className="lg:w-2/3 md:w-1/2 w-11/12 lg:h-auto sm:h-auto h-[20rem] bg-gray-900 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative"> */} 
            ...
            {/* <img src={img} alt="" className='w-[100%] absolute inset-0 '/>
            <div className="bg-[#1F2023] hidden relative sm:flex flex-wrap py-6 rounded shadow-md">
              ...
              <div className="lg:w-1/2 px-6 mt-4 lg:mt-0">
                <h2 className="title-font font-semibold text-[#F130A2] tracking-widest text-xs">EMAIL</h2>
                <a href="mailto:example@email.com" className=" leading-relaxed">pranjaligulhane04@gmail.com</a>
                <h2 className="title-font font-semibold text-[#F130A2] tracking-widest text-xs mt-4">PHONE</h2>
                <p className="leading-relaxed">9420063897, 9922824688</p>
              </div>
            </div>
          </div> */}
